        ...
        <div class="row py-3 border-bottom">
          ...
          <div class="col-sm-8 col-lg-2 d-flex gap-5 align-items-center justify-content-center justify-content-sm-end">
            <ul class="d-flex justify-content-end list-unstyled m-0">
              <li>
                <a href="db/login_form.php" class="p-2 mx-1">
...
if ($conn->connect_error) {
    ...
    // Fetch category and validate input
    $category_name = "Bespoke Cakes"; // Set category 
    $category_name = $conn->real_escape_string($category_name); // Prevent SQL injection

    // Fetch the category ID where name matches and is_visible is 1
    $category_query = "SELECT id FROM categories WHERE name = ? AND is_visible = 1";
    ...
    if ($category_result->num_rows > 0) {
        ...
        // Fetch products that match the category_id and in_stock is 1
        $product_query = "
            SELECT name, description, image_path, price, is_best_seller, is_featured, is_popular, is_new 
            FROM products 
        ...
        if ($product_result->num_rows > 0) {
            echo "<div class='row g-3'>"; // Bootstrap row container

            while ($product = $product_result->fetch_assoc()) {
                // Calculating a sample discount and setting static reviews for demo purposes
                $original_price = $product['price'] * 1.2; // Assuming a 20% discount
                ...
                <div class='col'>
                    ...
                    <figure>
                        <a href='#' title='" . htmlspecialchars($product['name']) . "'>
                        <img src='" . htmlspecialchars($product['image_path']) . "' alt='" . htmlspecialchars($product['name']) . "' class='tab-image'>
                        </a>
                    </figure>
                    <div class='d-flex flex-column text-center'>
                        ...
                        <span class='badge border border-dark-subtle rounded-0 fw-normal px-1 fs-7 lh-1 text-body-tertiary'>$discount_percentage% OFF</span>
                        </div>
            ...
            echo "</div>"; // Close Bootstrap row container
        } else {
        ...
        echo "<p>Category not found or not visible.</p>";
    }
          ...
          <div class="col-md-2 col-sm-6">
            <div class="footer-menu">
              ...
              <ul class="menu-list list-unstyled">
                ...
                <li class="menu-item">
                  <a href="#" class="nav-link">Discount Codes</a>
                </li>
                <li class="menu-item">
